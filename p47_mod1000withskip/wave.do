...
add wave -noupdate -format Logic -radix unsigned /tb/uut/eq500
add wave -noupdate -format Logic -radix unsigned /tb/uut/eq999
add wave -noupdate -format Literal -radix unsigned /tb/uut/cntplus1
add wave -noupdate -format Literal -radix unsigned /tb/uut/b2
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {9005 ps} 0}
...
update
WaveRestoreZoom {8656 ps} {9334 ps}
